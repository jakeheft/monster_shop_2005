...
RSpec.describe 'merchant show page', type: :feature do
  describe 'As a user' do
    before :each do
      ...
      @order_2.item_orders.create!(item: @dog_bone, price: @dog_bone.price, quantity: 2, merchant_id: @brian.id)
      @order_2.item_orders.create!(item: @pull_toy, price: @pull_toy.price, quantity: 2, merchant_id: @brian.id)
      @order_2.item_orders.create!(item: @tire, price: @tire.price, quantity: 2, merchant_id: @meg.id)
      @order_3.item_orders.create!(item: @dog_bone, price: @dog_bone.price, quantity: 5, merchant_id: @brian.id)
    end
