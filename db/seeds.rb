...
order1 = Order.create!(name: 'JakeBob', address: '124 Main St', city: 'Denver',state: 'Colorado', zip: '80202', user_id: jake.id, status: "Shipped")
order2 = Order.create!(name: 'JakeBob', address: '124 Main St', city: 'Denver',state: 'Colorado', zip: '80202', user_id: jake.id, status: "Shipped")
...
order1.item_orders.create!(item_id: tire1.id, price: tire1.price, quantity: 10, status: "Packaged")
order1.item_orders.create!(item_id: pen.id, price: pen.price, quantity: 9, status: "Packaged")
order1.item_orders.create!(item_id: ball.id, price: ball.price, quantity: 8, status: "Packaged")
order1.item_orders.create!(item_id: straw.id, price: straw.price, quantity: 7, status: "Packaged")
order2.item_orders.create!(item_id: eraser.id, price: eraser.price, quantity: 6, status: "Packaged")
order2.item_orders.create!(item_id: stick.id, price: stick.price, quantity: 5, status: "Packaged")
order2.item_orders.create!(item_id: toothpick.id, price: toothpick.price, quantity: 4, status: "Packaged")
order3.item_orders.create!(item_id: trash.id, price: trash.price, quantity: 3, status: "Packaged")
order3.item_orders.create!(item_id: wrapper.id, price: wrapper.price, quantity: 2, status: "Packaged")
order3.item_orders.create!(item_id: film2.id, price: film2.price, quantity: 1, status: "Packaged")

order4.item_orders.create!(item_id: tire2.id, price: tire2.price, quantity: 10, status: "Packaged")
order4.item_orders.create!(item_id: pen.id, price: pen.price, quantity: 9, status: "Packaged")
order5.item_orders.create!(item_id: ball.id, price: ball.price, quantity: 8, status: "Packaged")
order5.item_orders.create!(item_id: straw.id, price: straw.price, quantity: 7, status: "Packaged")
order6.item_orders.create!(item_id: eraser.id, price: eraser.price, quantity: 6, status: "Packaged")
order7.item_orders.create!(item_id: stick.id, price: stick.price, quantity: 5, status: "Packaged")
order8.item_orders.create!(item_id: toothpick.id, price: toothpick.price, quantity: 4, status: "Packaged")
order9.item_orders.create!(item_id: trash.id, price: trash.price, quantity: 3, status: "Packaged")
order10.item_orders.create!(item_id: wrapper.id, price: wrapper.price, quantity: 2, status: "Packaged")
order1.item_orders.create!(item_id: film3.id, price: film3.price, quantity: 1, status: "Packaged")

order1.item_orders.create!(item_id: tire1.id, price: tire1.price, quantity: 10, status: "Packaged")
order4.item_orders.create!(item_id: pen.id, price: pen.price, quantity: 9, status: "Packaged")
order4.item_orders.create!(item_id: ball.id, price: ball.price, quantity: 8, status: "Packaged")
order8.item_orders.create!(item_id: straw.id, price: straw.price, quantity: 7, status: "Packaged")
order8.item_orders.create!(item_id: eraser.id, price: eraser.price, quantity: 6, status: "Packaged")
order8.item_orders.create!(item_id: stick.id, price: stick.price, quantity: 5, status: "Packaged")
order2.item_orders.create!(item_id: toothpick.id, price: toothpick.price, quantity: 4, status: "Packaged")
order2.item_orders.create!(item_id: trash.id, price: trash.price, quantity: 3, status: "Packaged")
order3.item_orders.create!(item_id: wrapper.id, price: wrapper.price, quantity: 2, status: "Packaged")
order3.item_orders.create!(item_id: film4.id, price: film4.price, quantity: 1, status: "Packaged")

order1.item_orders.create!(item_id: tire1.id, price: tire1.price, quantity: 10, status: "Packaged")
order4.item_orders.create!(item_id: film3.id, price: film3.price, quantity: 9, status: "Packaged")
order4.item_orders.create!(item_id: film2.id, price: film2.price, quantity: 8, status: "Packaged")
order8.item_orders.create!(item_id: film2.id, price: film2.price, quantity: 7, status: "Packaged")
order8.item_orders.create!(item_id: film4.id, price: film4.price, quantity: 6, status: "Packaged")
order8.item_orders.create!(item_id: pen.id, price: pen.price, quantity: 5, status: "Packaged")
order2.item_orders.create!(item_id: stick.id, price: stick.price, quantity: 4, status: "Packaged")
order2.item_orders.create!(item_id: stick.id, price: stick.price, quantity: 3, status: "Packaged")
order3.item_orders.create!(item_id: film1.id, price: film1.price, quantity: 2, status: "Packaged")
order3.item_orders.create!(item_id: film4.id, price: film4.price, quantity: 1, status: "Packaged")
